...
class DashboardAdmin {
        ...
        evaluaciones.forEach(evaluacion => {
            ...
            tr.innerHTML = `
                ...
                <td>
                    ...
                    <br>
                    <button class="btn btn-sm btn-info me-1 mt-1" onclick="dashboardAdmin.viewEvaluacion(${evaluacion.id})" title="Ver detalles">
                        <i class="bi bi-eye"></i>
                    </button>
                    <button class="btn btn-sm btn-warning me-1 mt-1" onclick="dashboardAdmin.editEvaluacion(${evaluacion.id})" title="Editar">
                        <i class="bi bi-pencil"></i>
                    </button>
                    <button class="btn btn-sm btn-danger mt-1" onclick="dashboardAdmin.deleteEvaluacion(${evaluacion.id})" title="Eliminar">
                        <i class="bi bi-trash"></i>
                    </button>
                </td>
            `;
    ...
    async editEvaluacion(id) {
        try {
            console.log('🔧 Editando evaluación:', id);
            
            // Encontrar la evaluación actual
            ...
            const modalHtml = `
                <div class="modal fade" id="editEvaluacionModal" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                ...
                                <form id="editEvaluacionForm">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control" value="${evaluacion.paciente_nombre || 'N/A'}" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label">Odontólogo</label>
                                            <input type="text" class="form-control" value="${evaluacion.odontologo_nombre || 'N/A'}" readonly>
                                        </div>
                                    </div>
                                    
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            <label class="form-label">Calificación Servicio</label>
                                            <select class="form-control" id="calificacionServicio">
                                                <option value="1" ${evaluacion.calificacion_servicio == 1 ? 'selected' : ''}>1 - Muy malo</option>
                                                <option value="2" ${evaluacion.calificacion_servicio == 2 ? 'selected' : ''}>2 - Malo</option>
                                                <option value="3" ${evaluacion.calificacion_servicio == 3 ? 'selected' : ''}>3 - Regular</option>
                                                <option value="4" ${evaluacion.calificacion_servicio == 4 ? 'selected' : ''}>4 - Bueno</option>
                                                <option value="5" ${evaluacion.calificacion_servicio == 5 ? 'selected' : ''}>5 - Excelente</option>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label">Calificación Atención</label>
                                            <select class="form-control" id="calificacionAtencion">
                                                <option value="1" ${evaluacion.calificacion_odontologo == 1 ? 'selected' : ''}>1 - Muy malo</option>
                                                <option value="2" ${evaluacion.calificacion_odontologo == 2 ? 'selected' : ''}>2 - Malo</option>
                                                <option value="3" ${evaluacion.calificacion_odontologo == 3 ? 'selected' : ''}>3 - Regular</option>
                                                <option value="4" ${evaluacion.calificacion_odontologo == 4 ? 'selected' : ''}>4 - Bueno</option>
                                                <option value="5" ${evaluacion.calificacion_odontologo == 5 ? 'selected' : ''}>5 - Excelente</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-4">
                                            ...
                                            <select class="form-control" id="calificacionInstalaciones">
                                                <option value="1" ${evaluacion.calificacion_instalaciones == 1 ? 'selected' : ''}>1 - Muy malo</option>
                                                <option value="2" ${evaluacion.calificacion_instalaciones == 2 ? 'selected' : ''}>2 - Malo</option>
                                                <option value="3" ${evaluacion.calificacion_instalaciones == 3 ? 'selected' : ''}>3 - Regular</option>
                                                <option value="4" ${evaluacion.calificacion_instalaciones == 4 ? 'selected' : ''}>4 - Bueno</option>
                                                <option value="5" ${evaluacion.calificacion_instalaciones == 5 ? 'selected' : ''}>5 - Excelente</option>
                                            </select>
                                        </div>
                                        <div class="col-4">
                                            <label class="form-label">Limpieza</label>
                                            <select class="form-control" id="calificacionLimpieza">
                                                <option value="1" ${evaluacion.calificacion_limpieza == 1 ? 'selected' : ''}>1 - Muy malo</option>
                                                <option value="2" ${evaluacion.calificacion_limpieza == 2 ? 'selected' : ''}>2 - Malo</option>
                                                <option value="3" ${evaluacion.calificacion_limpieza == 3 ? 'selected' : ''}>3 - Regular</option>
                                                <option value="4" ${evaluacion.calificacion_limpieza == 4 ? 'selected' : ''}>4 - Bueno</option>
                                                <option value="5" ${evaluacion.calificacion_limpieza == 5 ? 'selected' : ''}>5 - Excelente</option>
                                            </select>
                                        </div>
                                        <div class="col-4">
                                            <label class="form-label">Puntualidad</label>
                                            <select class="form-control" id="calificacionPuntualidad">
                                                <option value="1" ${evaluacion.calificacion_puntualidad == 1 ? 'selected' : ''}>1 - Muy malo</option>
                                                <option value="2" ${evaluacion.calificacion_puntualidad == 2 ? 'selected' : ''}>2 - Malo</option>
                                                <option value="3" ${evaluacion.calificacion_puntualidad == 3 ? 'selected' : ''}>3 - Regular</option>
                                                <option value="4" ${evaluacion.calificacion_puntualidad == 4 ? 'selected' : ''}>4 - Bueno</option>
                                                <option value="5" ${evaluacion.calificacion_puntualidad == 5 ? 'selected' : ''}>5 - Excelente</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="comentarios" rows="4">${evaluacion.comentarios || ''}</textarea>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">¿Recomendaría nuestros servicios?</label>
                                        <select class="form-control" id="recomendaria">
                                            <option value="true" ${evaluacion.recomendaria ? 'selected' : ''}>Sí</option>
                                            <option value="false" ${!evaluacion.recomendaria ? 'selected' : ''}>No</option>
                                        </select>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="dashboardAdmin.saveEvaluacion()">Guardar Cambios</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            // Mostrar modal
            const modal = new bootstrap.Modal(document.getElementById('editEvaluacionModal'));
            modal.show();

            // Limpiar modal al cerrarse
            document.getElementById('editEvaluacionModal').addEventListener('hidden.bs.modal', function () {
                this.remove();
            });
    ...
    async saveEvaluacion() {
        try {
            ...
            const formData = {
                calificacion_servicio: parseInt(document.getElementById('calificacionServicio').value),
                calificacion_atencion: parseInt(document.getElementById('calificacionAtencion').value),
                calificacion_instalaciones: parseInt(document.getElementById('calificacionInstalaciones').value),
                calificacion_limpieza: parseInt(document.getElementById('calificacionLimpieza').value),
                calificacion_puntualidad: parseInt(document.getElementById('calificacionPuntualidad').value),
                comentarios: document.getElementById('comentarios').value,
                recomendaria: document.getElementById('recomendaria').value === 'true'
            };
            ...
            // Cerrar modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('editEvaluacionModal'));
            modal.hide();
        ...
        for (let semana = 0; semana < 6; semana++) {
            ...
            for (let dia = 0; dia < 7; dia++) {
                ...
                if (semana === 0 && dia < primerDiaSemana) {
                    ...
                    td.innerHTML = '<div class="text-muted"></div>';
                } else if (fecha > diasEnMes) {
                    // Días del mes siguiente
                    td.innerHTML = '<div class="text-muted"></div>';
                } else {
                    // Días del mes actual
                    const esHoy = (fecha === hoy.getDate() && 
                                   month === hoy.getMonth() && 
                                   year === hoy.getFullYear());
                    
                    td.innerHTML = `
                        <div class="calendar-day ${esHoy ? 'today' : ''}" data-fecha="${year}-${(month + 1).toString().padStart(2, '0')}-${fecha.toString().padStart(2, '0')}">
                            <span class="day-number">${fecha}</span>
                            <div class="citas-count" id="citas-${fecha}"></div>
                        </div>
                    `;
                    fecha++;
                }
    ...
    async cargarCitasDelMes() {
        try {
            ...
            const res = await this.authFetch(`/api/citas/mes/${year}/${month + 1}`);
            const citas = await res.json();
            
            // Limpiar contadores anteriores
            document.querySelectorAll('.citas-count').forEach(el => el.textContent = '');
            ...
            // Mostrar contadores en el calendario
            Object.keys(citasPorDia).forEach(dia => {
                const contador = document.getElementById(`citas-${dia}`);
                if (contador) {
                    contador.textContent = `${citasPorDia[dia]} cita${citasPorDia[dia] > 1 ? 's' : ''}`;
                    contador.className = 'citas-count text-primary small';
                }
            });
...
} // Fin de la clase DashboardAdmin

// Crear instancia global única
window.dashboardAdmin = new DashboardAdmin();

} // Fin del if (!window.dashboardAdmin)

} // Fin del else de window.dashboardAdminInitialized
...
document.addEventListener('DOMContentLoaded', () => {
    if (!window.dashboardAdmin) {
        ...
        console.log('✅ DashboardAdmin ya existe, saltando inicialización');
    }
});